module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            amd: {
                src: 'dist/geocas.js',
                dest: 'dist/geocas.min.js'
            },
            system: {
                src: 'dist/geocas-system-es5.js',
                dest: 'dist/geocas-system-es5.min.js'
            }
        },
        ...
        typedoc: {
            build: {
                options: {
                    ...
                    out: 'documentation/',
                    mode: 'file',
                    name: 'GeoCAS <%= pkg.version %>',
                    exclude: [
                        'src/geocas/core/ErrorMode.ts',
                        'src/geocas/shapes/ArrowBuilder.ts',
                        '**/*.spec.ts'
                    ],
    ...
    function bundle() {
        ...
        return builder.bundle('geocas.js', 'dist/geocas-system-es5.js', options);
    }
