import bigRat from './BigRational';
import {one, zero, minusOne} from './BigRational';
...
describe("BigRational", function() {
    ...
    describe("addition", function() {
        it("works", function() {
            ...
            expect(one.add(zero).add(minusOne)).toEqual(0);
        });
    });
    ...
    describe("valueOf", function() {
        it("works", function() {
            expect(bigRat(1, 4).valueOf() + bigRat(3 / 4).valueOf() === 1).toBe(true);
