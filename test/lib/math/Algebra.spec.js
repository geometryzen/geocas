...
var Algebra_2 = require("./Algebra");
var Algebra_3 = require("./Algebra");
describe("Algebra", function () {
    describe("G3", function () {
        var g3 = new Algebra_1.default([[1, 0, 0], [0, 1, 0], [0, 0, 1]]);
        var uno = g3.scalar(1);
        var one = g3.basis[0];
        var two = uno.__add__(uno);
        var u2 = uno.__wedge__(uno);
        var e1 = g3.basis[1];
        var e2 = g3.basis[2];
        var e12 = e1.__wedge__(e2);
        var e3 = g3.basis[4];
        var e13 = e1.__wedge__(e3);
        var e23 = e2.__wedge__(e3);
        var e123 = e12.__wedge__(e3);
        ...
        describe("__sub__", function () {
            it("(Expr)", function () {
                var expr = e1.__sub__(e2);
                expect(expr.toPrefix()).toBe("sub(e1, e2)");
                expect(expr.toString()).toBe("e1 - e2");
            });
            it("(number)", function () {
                var expr = e1.__sub__(5);
        ...
        describe("__rsub__", function () {
            it("(Expr)", function () {
                var expr = e1.__rsub__(e2);
                expect(expr.toPrefix()).toBe("sub(e2, e1)");
                expect(expr.toString()).toBe("e2 - e1");
            });
            it("(number)", function () {
                var expr = e1.__rsub__(5);
        ...
        describe("__mul__", function () {
            it("(Expr)", function () {
                var expr = e1.__mul__(e2);
                expect(expr.toPrefix()).toBe("mul(e1, e2)");
                expect(expr.toString()).toBe("e1 * e2");
            });
            it("(number)", function () {
                var expr = e1.__mul__(5);
        ...
        describe("__rmul__", function () {
            it("(Expr)", function () {
                var expr = e1.__rmul__(e2);
                expect(expr.toPrefix()).toBe("mul(e2, e1)");
                expect(expr.toString()).toBe("e2 * e1");
            });
            it("(number)", function () {
                var expr = e1.__rmul__(5);
        ...
        describe("__div__", function () {
            it("(Expr)", function () {
                var expr = e1.__div__(e2);
                expect(expr.toPrefix()).toBe("div(e1, e2)");
                expect(expr.toString()).toBe("e1 / e2");
            });
            it("(number)", function () {
                var expr = e1.__div__(5);
        ...
        describe("__rdiv__", function () {
            it("(Expr)", function () {
                var expr = e1.__rdiv__(e2);
                expect(expr.toPrefix()).toBe("div(e2, e1)");
                expect(expr.toString()).toBe("e2 / e1");
            });
            it("(number)", function () {
                var expr = e1.__rdiv__(5);
        ...
        describe("__vbar__", function () {
            it("(Expr)", function () {
                var expr = e1.__vbar__(e2);
                expect(expr.toPrefix()).toBe("scp(e1, e2)");
                expect(expr.toString()).toBe("e1 | e2");
            });
            it("(number)", function () {
                var expr = e1.__vbar__(5);
        ...
        describe("__rvbar__", function () {
            it("(Expr)", function () {
                var expr = e1.__rvbar__(e2);
                expect(expr.toPrefix()).toBe("scp(e2, e1)");
                expect(expr.toString()).toBe("e2 | e1");
            });
            it("(number)", function () {
                var expr = e1.__rvbar__(5);
        ...
        describe("__lshift__", function () {
            it("(Expr)", function () {
                var expr = e1.__lshift__(e2);
                expect(expr.toPrefix()).toBe("lco(e1, e2)");
                expect(expr.toString()).toBe("e1 << e2");
            });
            it("(number)", function () {
                var expr = e1.__lshift__(5);
        ...
        describe("__rlshift__", function () {
            it("(Expr)", function () {
                var expr = e1.__rlshift__(e2);
                expect(expr.toPrefix()).toBe("lco(e2, e1)");
                expect(expr.toString()).toBe("e2 << e1");
            });
            it("(number)", function () {
                var expr = e1.__rlshift__(5);
        ...
        describe("__rshift__", function () {
            it("(Expr)", function () {
                var expr = e1.__rshift__(e2);
                expect(expr.toPrefix()).toBe("rco(e1, e2)");
                expect(expr.toString()).toBe("e1 >> e2");
            });
            it("(number)", function () {
                var expr = e1.__rshift__(5);
        ...
        describe("__rrshift__", function () {
            it("(Expr)", function () {
                var expr = e1.__rrshift__(e2);
                expect(expr.toPrefix()).toBe("rco(e2, e1)");
                expect(expr.toString()).toBe("e2 >> e1");
            });
            it("(number)", function () {
                var expr = e1.__rrshift__(5);
        ...
        describe("__wedge__", function () {
            it("(Expr)", function () {
                var expr = e1.__wedge__(e2);
                expect(expr.toPrefix()).toBe("ext(e1, e2)");
                expect(expr.toString()).toBe("e1 ^ e2");
            });
            it("(number)", function () {
                var expr = e1.__wedge__(5);
        ...
        describe("__rwedge__", function () {
            it("(Expr)", function () {
                var expr = e1.__rwedge__(e2);
                expect(expr.toPrefix()).toBe("ext(e2, e1)");
                expect(expr.toString()).toBe("e2 ^ e1");
            });
            it("(number)", function () {
                var expr = e1.__rwedge__(5);
        ...
        it("extension", function () {
            ...
            expect(e123 instanceof Algebra_3.WedgeExpr).toBeTruthy();
        ...
        describe("", function () {
            it("simplify", function () {
                ...
                expect(g3.simplify(e12) instanceof Algebra_2.BasisBladeExpr).toBeTruthy();
                expect(g3.simplify(e12).toString()).toBe("e1 ^ e2");
                expect(g3.simplify(e1.__wedge__(e1)).toString()).toBe("0");
            });
            it("e1 ^ e2", function () {
        ...
        describe("hoisting scalar through * *", function () {
            describe("(5 * e1) * e2", function () {
                var s = g3.scalar(5);
                var expr = s.__mul__(e1).__mul__(e2);
            ...
            describe("*(*(e1, 5), e2)", function () {
                var s = g3.scalar(5);
                var expr = e1.__mul__(s).__mul__(e2);
                it("should hoist", function () {
            ...
            describe("*(e1, *(5, e2))", function () {
                var s = g3.scalar(5);
                var expr = s.__mul__(e2).__rmul__(e1);
                it("should hoist", function () {
            ...
            describe("*(e1, *(e2, 5))", function () {
                var s = g3.scalar(5);
                var expr = e2.__mul__(s).__rmul__(e1);
                it("should hoist", function () {
            ...
            describe("(e1 * e2) * 5", function () {
                var s = g3.scalar(5);
                var expr = e1.__mul__(e2).__mul__(s);
                it("should hoist", function () {
